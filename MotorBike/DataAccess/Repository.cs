...
public class Repository<T> : IRepository<T> where T : class
{
    ...
    private static readonly Dictionary<Type, TableMeta> _tableMap = new()
    {
        ...
        [typeof(Models.ReBuyPayment)]  = new("ReBuy_Payments", "Pay_ID",   "PayId"),
        [typeof(Models.ReSale)]        = new("ReSales",        "Sales_ID", "SalesId"),
        [typeof(Models.ReSalesSub)]    = new("ReSales_Sub",    "ID",       "Id"),
        [typeof(Models.ReSalesPayment)]= new("ReSales_Payments","Pay_ID",  "PayId"),
        [typeof(Models.SalesCar)]      = new("Sales_Car",      "Sales_ID", "SalesId"),
        [typeof(Models.SalesCarPayment)] = new("Sales_Car_Payments", "Pay_ID", "PayId"),
        [typeof(Models.SalesPayment)]  = new("Sales_Payments", "Pay_ID",   "PayId"),
        [typeof(Models.TblCost)]       = new("TblCost",        "ID",       "Id"),
        [typeof(Models.BuyCar)]        = new("Buy_Car",        "Buy_ID",   "BuyId"),
        [typeof(Models.BuyCarPayment)] = new("Buy_Car_Payments", "Pay_ID", "PayId"),
        [typeof(Models.BuyPayment)]    = new("Buy_Payments",   "Pay_ID",   "PayId"),
        [typeof(Models.Car)]           = new("Cars",           "Car_ID",   "CarId"),
        [typeof(Models.ImportExp)]     = new("Import_Exp",     "ID",       "Id"),
        [typeof(Models.ImportExpense)] = new("Import_Expenses","Exp_ID",   "ExpId"),
        [typeof(Models.ImportInvCar)]  = new("Import_Inv_Car", "ID",       "Id"),
        [typeof(Models.ImportInvItem)] = new("Import_Inv_Item","ID",       "Id"),
