...
public class ReBuyInvoiceItemModel
{
...
public class ReBuyInvoiceModel
{
    ...
    public List<ReBuyInvoiceItemModel> Items { get; set; } = new();
...
public class ReBuyInvoiceDocument : IDocument
{
    private readonly ReBuyInvoiceModel _model;
    private readonly Company _company;

    public ReBuyInvoiceDocument(ReBuyInvoiceModel model, Company company)
    {
        _model = model;
        _company = company;
    ...
    private void ComposeHeader(IContainer container)
    {
        container.Column(column =>
        {
            ...
            column.Item().PaddingTop(8).Row(titleRow =>
            {
                ...
                titleRow.RelativeItem(3).AlignCenter().Text("مرتجع مشتريات").FontSize(18).SemiBold().FontColor(Colors.Black);
    ...
    {
        var list = new List<KeyValuePair<string, string>> { new("الإجمالي", _model.Total.ToString("N2")) };
