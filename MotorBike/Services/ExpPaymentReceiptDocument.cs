...
public class ExpPaymentReceiptModel
{
...
public class ExpPaymentReceiptDocument : IDocument
{
    private readonly ExpPaymentReceiptModel _model;
    private readonly Company _company;

    public ExpPaymentReceiptDocument(ExpPaymentReceiptModel model, Company company)
    {
    ...
    private void ComposeHeader(IContainer container)
    {
        container.Column(column =>
        {
            ...
            column.Item().PaddingTop(8).AlignCenter().Text("إيصال صرف مصروفات").FontSize(18).SemiBold().FontColor(Colors.Black);
    ...
    private void ComposeTotals(IContainer container)
    {
        var totals = new List<KeyValuePair<string, string>>
        {
            ...
            new("رصيد الخزينة قبل", _model.PreviousBalance.ToString("N2")),
            new("رصيد الخزينة بعد", _model.BalanceAfter.ToString("N2")),
        };
