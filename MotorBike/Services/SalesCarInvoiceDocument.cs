...
public class SalesCarInvoiceModel
{
...
public class SalesCarInvoiceDocument : IDocument
{
    private readonly SalesCarInvoiceModel _model;
    private readonly Company _company;

    public SalesCarInvoiceDocument(SalesCarInvoiceModel model, Company company)
    {
        _model = model;
        _company = company;
    ...
    private void ComposeHeader(IContainer container)
    {
        container.Column(column =>
        {
            ...
            column.Item().PaddingTop(8).Row(titleRow =>
            {
                ...
                titleRow.RelativeItem(3).AlignCenter().Text("فاتورة بيع موتوسيكل").FontSize(18).SemiBold().FontColor(Colors.Black);
