...
public class SuppPaymentReceiptModel
{
...
public class SuppPaymentReceiptDocument : IDocument
{
    private readonly SuppPaymentReceiptModel _model;
    private readonly Company _company;

    public SuppPaymentReceiptDocument(SuppPaymentReceiptModel model, Company company)
    {
    ...
    private void ComposeContent(IContainer container)
    {
        container.PaddingVertical(5).Column(col =>
        {
            var fields = new List<KeyValuePair<string, string>>
            {
                ...
                new("المورد", _model.SupplierName), new("الخزينة", _model.CashName),
            };
